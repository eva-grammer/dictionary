...
**involve** \[ɪn'vɒlv] vt. 包含； 牵涉； 使陷于； 潜心于 657
...
**involved** \[ɪn'vɒlvd]adj. 卷入的；有关的；复杂的 1178

***

**involvement** \[ɪn'vɒlvm(ə)nt] n. 牵连；混乱；包含；财政困难 2331
...
**revolve** \[rɪ'vɒlv] vi. 旋转； 循环出现； 反复考虑 7521
...
**revolution** \[revə'lu:ʃ(ə)n]n. 革命；旋转；运行；循环 2781
...
**revolutionary** \[revə'lu:ʃ(ə)n(ə)rɪ] adj. 革命的；旋转的；大变革的 4054
...
**revolutionize** \['rɛvə'lʊʃə'naɪz] vt. 使彻底革命， 使颠覆 11331

***

**revolver** \[rɪ'vɒlvə] n. 左轮手枪；旋转器 11305

***

**revolving** \[rɪ'vɒlvɪŋ] adj. 旋转的 12868

***

**revolt** \[rɪ'vəʊlt] vi. 反抗； 反叛； 拒绝服从 9161

***

**evolve** \[ɪ'vɒlv] vt. 发展，进化；进化；使逐步形成；推断出 2845
...
**evolutionary** \[,i\:və'lu:ʃənərɪ]adj. 进化的；发展的；渐进的 5471
...
**evolving** \[ɪ'vɒlvɪŋ] adj. 展开的； 进化的 13711
...
**shifter** \['ʃɪftɚ] n.移动装置；搬移东西者 18274
...
**shifting** \['ʃɪftɪŋ] adj. 不断移动的； 流动的 n. 狡猾； 移位 7507
...
**distort** \[dɪ'stɔ\:t] vt. 扭曲； 曲解； 使失真 6724
...
**distorted** \[dɪ'stɔ\:tɪd] adj. 歪曲的； 受到曲解的 11064
...
**anniversary** \[ænɪ'vɜ\:s(ə)rɪ] n. 周年纪念日 3403
...
**volume** \['vɒlju\:m] n. 体积；卷；册；音量；大量；量 1931
...
**voluminous** \[və'lju\:mɪnəs] adj. 多卷的， 长篇的； 大量的； 著书多的 16136
...
**inverse** \['ɪnvɜ\:s; ɪn'vɜ\:s] n. 倒转；相反 adj. 相反的，逆向的 17286

***

**inversion** \[ɪn'vɜ:ʃ(ə)n] n. 倒置； 倒转； 反向 14971

***

**invert** \[ɪn'vɜ\:t] vt. 使…转化； 使…颠倒； 使…反转； 使…前后倒置 16606

***

**invertebrate** \[ɪn'vɜ\:tɪbrət]adj. 无脊椎的；无骨气的 18918

***

**inverted** \[ɪn'vɜ\:tɪd] adj. 倒转的，反向的 14127
...
**vertebra** \['vɜ\:tɪbrə] n. 脊椎;椎骨;脊柱 14764
...
**evert** \[ɪ'vɜ\:t] v 使(眼皮、 肠或身体其它部位等)外翻 241

**助记：** e（ =ex：外） +vert（转；翻转）→使...外翻

***

**extrovert** \[ˈekstrəvɜ\:t] adj. 外向的； 活泼友好的

***

**introvert** \[ˈɪntrəvɜ\:t] ad.j/n. 性格内向的人； 不爱交际的人
...
**malversation** \[ˌmælvɜ:'seɪʃən] n. （ 政府机关等的） 腐败行为; 渎职; 贪污; 盗用
...
**pervert** \[pəˈvɜ\:t] vt. 破坏； 颠覆； 使走样； 误导
...
**reverberate** \[rɪ'vɜ\:bəreɪt] vt. 使回响；使反射；使弹回 12949
...
**subvert** \[səb'vɜ\:t] vt. 推翻； 颠覆； 破坏 11710

**助记：** sub（ =under：下） +vert（转）→（让某政权/某事）转下去→推翻，颠覆

***

**subversion** \[səb'vɜ:ʃən] n. 颠覆； 破坏 16934

***

**subversive** \[səb'vɜ\:sɪv] adj. 破坏性的； 从事颠覆的 11583

***

**transverse** \[ˈtrænzvɜ\:s] adj. 横的;横向的;横断的;横切的

**助记：** trans（ =across： 穿过） +vers（ 转） +e→转过去、 穿过去→横穿的； 横向的

***

**verge** \[vɜ\:dʒ] vi. 濒临， 接近； 处在边缘 6741
...
**vertex** \[ˈvɜ\:teks] n. 最高点; 顶点; <数>（ 三角形、 圆锥体等与底相对的） 顶

**助记：** vert（ 转） +ex（ 名词后缀） →（ 原指） 转折点， 后面引申为“ 最高点”（ 因为转折点一般也是“最高点”， 然后就急转而下）

***

**vertigo** \['vɜ\:tɪgəʊ] n. 晕头转向， 眩晕 14733

**助记：** vert（ 转） +go（ 走） →转着走→晕头转向； 眩晕

***

**vortex** \['vɔ\:teks] n. 涡流； 漩涡； 旋风；（ 动乱， 争论等的） 中心 14893
...
**warp** \[wɔ\:p] vt. (尤指因受热、 受潮而)(使)翘曲； (使)变形； 扭曲； 摧毁； 不利于 1321
...
**wrench** \[ren(t)ʃ] n. 扳手， 扳钳； 歪曲； 猛扭； 扭伤； 痛苦 10649
...
**wrestling** \['reslɪŋ] n. \[体]摔跤； \[体]扭斗 7003

***

**wriggle** \['rɪg(ə)l] vi. 蠕动； 蜿蜒而行 14148
...
**wrinkled** \['rɪŋkld] adj. 具皱的， 有皱纹的 11080
...
**circumvolve** \[ˌsɜ\:kəm'vɒlv] vi. 旋转
...
**convoluted** \[,kɒnvə'l(j)u\:tɪd] adj. 旋绕的；复杂的；费解的 19179

**助记：** con（一起） +vol（ =roll：卷，绕）→（想法/系统）卷/绕到一起→复杂的；费解的；难懂的

***

**devolve** \[dɪ'vɒlv] vi. 被移交； 转让 19062
...
![image](https://github.com/eva-grammer/dictionary/raw/main/docs/img/0801.jpg)
